...
class TbfcCmdLineTest extends TestCase
{
    ...
    private $MOCK_GPS_POSITION_IN= __DIR__ . "/mock/in_csv_gps_position.csv";
    private $MOCK_GPS_POSITION_OUT= __DIR__ . "/mock/out_csv_gps_position.csv";
    ...
    {
        phore_exec("/opt/bin/otic.php --otic --pack --autoload=/opt/doc/middleware/gps_position_middleware.php --failOnErr --input=$this->MOCK_GPS_POSITION_IN --out=/tmp/out.tbfc");
        phore_exec("/opt/bin/otic.php --otic --unpack --input=/tmp/out.tbfc --out=/tmp/out_compare.csv");

        $this->assertFileEquals($this->MOCK_GPS_POSITION_OUT, "/tmp/out_compare.csv");
    }
    ...
    */
    ...
    public function testAfterCmd()
    {
        ...
        phore_exec("/opt/bin/otic.php --otic --pack --failOnErr --input=$this->MOCK_4COL_BASIC_DATA --afterCmd='cat %f > /tmp/out_compare3.bin' --out=/tmp/out3.otic");
